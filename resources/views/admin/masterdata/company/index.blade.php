<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    @section('title')
        <title>Company</title>
    @endsection
    <x-navbars.sidebar activePage="company.index"></x-navbars.sidebar>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white mx-3">Data Company
                                </h6>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($company as $item)
                                            <tr>
                                                ...
                                                <td class="align-middle text-wrap text-sm">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm text-center text-wrap">
                                                            {{ $item->address }}</h6>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm text-center">{{ $item->no_hp ?? '-' }}
                                                        </h6>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm text-center">{{ $item->pic ?? '-' }}
                                                        </h6>
                                                    </div>
                                                </td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form">
                                <form action="{{ route('company.store') }}" id="add-form" method="POST">
                                    @csrf
                                    @method('post')
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control border border-2 p-2"
                                            placeholder="input address" name="address" required autocomplete="off">
                                    </div>
                                    <div class="mb-3">
