<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    @section('title')
        <title>Zona</title>
    @endsection
    <x-navbars.sidebar activePage="zona.index"></x-navbars.sidebar>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white mx-3">Data Zona
                                </h6>
                            </div>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form">
                                <form action="{{ route('zona.store') }}" id="add-form" method="POST">
                                    @csrf
                                    @method('post')
                                    <div class="mb-3">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form">
                                <form action="{{ route('zona.update') }}" id="edit-form" method="POST">
                                    @csrf
                                    @method('put')
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form">
                                <form action="{{ route('zona.delete') }}" id="delete-form" method="POST">
                                    @csrf
                                    @method('delete')
