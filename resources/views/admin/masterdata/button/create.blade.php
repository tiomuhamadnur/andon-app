                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white mx-3">Create Data Button Configuration
                                </h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="container p-3">
                                <form action="{{ route('button.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Code (auto-generate from register device)</label>
                                        <div class="input-group mb-3">
                                            <input type="text" id="code" name="code"
                                                class="form-control border border-2 p-2" readonly required
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="input-group-append btn-group">
                                        <a href="{{ route('button.index') }}" class="btn btn-outline-danger">Cancel</a>
                                        <button style="display: none;" id="submit" class="btn btn-primary"
