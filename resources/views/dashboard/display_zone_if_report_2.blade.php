            ...
            <div class="row">
                <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4 mt-4 d-flex justify-content-center">
                    <div class="m-3">
                        ...
                        <a href="{{ route('display_zone_if_normal_2') }}">
                        ...
                        <div class="card-body d-flex stretch">
                            <div class="container mt-4">
                                <div class="row">
                                  <div class="col-12">
                                    <div class="card">
                                      <div class="card-header text-center if-report-header">
                                        Machine Call
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <div class="card-body d-flex stretch">
                            <div class="container">
                                <div class="row">
                                  <div class="col-12">
                                    <div class="card">
                                      <div class="card-header text-center flashing-card" style="border-radius: 15px;">
                                        <h4 style="color: white">Caution: Problem Occured! Please Remain Calm, Stay Safe and Follow The Instruction</h4>
                                      </div>
                                    </div>
                                  </div>
                                </div>
