                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="padding: 0 2.5em; text-align: left;">
                                        <div class="text">
                                            <h4>Dear {{ $data['gender'] ?? '' }}, <br> <b>{{ $data['name'] ?? '' }}</b>
                                                <br>
                                                <br>
                    ...
                    <tr>
                        <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0"
                            width="100%">
                            <tr
                                style="border-bottom: 1px solid rgba(0,0,0,.05); border-top: 1px solid rgba(0,0,0,.05);">
                                <td width="40%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <span style="color: #000; font-size: 15px;"><b>Tanggal</b> :
                                            {{ $data['date'] ?? '' }}
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td width="40%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <span style="color: #000; font-size: 15px;"><b>Waktu</b> :
                                            {{ $data['time'] ?? '' }} WIB
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td width="40%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <span style="color: #000; font-size: 15px;"><b>Building</b> :
                                            {{ $data['building'] ?? '' }}
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td width="40%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <span style="color: #000; font-size: 15px;"><b>Line</b> :
                                            {{ $data['line'] ?? '' }}
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td width="40%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <span style="color: #000; font-size: 15px;"><b>Zone</b> :
                                            {{ $data['zona'] ?? '' }}
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td width="40%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <span style="color: #000; font-size: 15px;"><b>Process</b> :
                                            {{ $data['process'] ?? '' }}
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td valign="middle" style="text-align:left; padding: 1em 2.5em;">
                                    <p><a href="{{ $data['url'] ?? '' }}" target="_blank" class="btn btn-primary">Lihat
                                            Detail</a></p>
                                </td>
                            </tr>
                            <tr>
                                <td class="hero bg_white" style="padding: 2em 0 0 0;">
